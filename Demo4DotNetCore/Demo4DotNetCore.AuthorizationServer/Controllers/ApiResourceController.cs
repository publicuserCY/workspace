...
namespace Demo4DotNetCore.AuthorizationServer.Controllers
{
    ...
    public class ApiResourceController : ControllerBase
    {
        ...
        {
            var result = new OperationResult<Model.PaginatedResult<IdentityServer4.EntityFramework.Entities.ApiResource>>(true);
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                result = new OperationResult<Model.PaginatedResult<IdentityServer4.EntityFramework.Entities.ApiResource>>(ex.Message);
            }
